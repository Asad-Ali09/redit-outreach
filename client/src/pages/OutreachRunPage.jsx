...
const OutreachRunPage = () => {
  ...
  const handleStartConversation = () => {
    ...
    if (selectedPostId && selectedReplyType) {
      dispatch(
        initiateConversation({
                  ...
                  >
                    ...
                    <div className="bg-gray-50 px-4 py-4 sm:px-6 flex justify-between items-center">
                      ...
                      {selectedPostId === post.id && showReplyOptions ? (
                        ...
                        <button
                          onClick={() => handleInitiateClick(post.id)}
                          className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md shadow-sm text-white bg-[#0079D3] hover:bg-[#006bb9] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0079D3]"
                        >
